...
<head>
    ...
    <link rel="stylesheet" href="assets/css/bulk-modal.css?v=<?=filemtime(__DIR__.'/assets/css/bulk-modal.css')?>">
...
<div class="input-section">
    <div class="input-row">
        ...
        <button class="secondary" onclick="openBulkAddModal()">Добавить артикулы списком</button>
    </div>
</div>
...
<div id="bulkArea" class="bulk-area" style="display:none;">
    <div class="hint">
        ...
        <code>90550_3000;5</code>, <code>90550_3000 x 2</code> или просто артикул.
        <br>
        <label style="margin-top:8px; display:inline-block;">
            <input type="checkbox" id="addAsSeparate" checked>
        </label>
    </div>
    <textarea id="bulkTextarea" placeholder="90550_3000;5&#10;90550_3000&#10;90550_3000 x 2"></textarea>
...
<?php include __DIR__ . '/includes/bulk-add-modal.html'; ?>
<script src="assets/js/bulk-modal.js?v=<?=filemtime(__DIR__.'/assets/js/bulk-modal.js')?>"></script>
</body>
</html>